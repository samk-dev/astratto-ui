<template>
  <AuSection>
    <AuContainer class="uk-container">
      <h1>Form</h1>
      ...
      <div uk-grid>
        <div class="uk-width-2-3@s">
          ...
          <form class="uk-form-horizontal">
            ...
            <div class="uk-margin">
              <label class="uk-form-label" for="form-h-datalist"
                >Datalist</label
              >
              <div class="uk-form-controls">
                <input
            ...
            <div class="uk-margin">
              ...
              <div class="uk-form-controls uk-form-controls-text">
                ...
                >
                <div
                  class="uk-margin uk-grid-small uk-child-width-auto"
                  uk-grid
                >
                  <label
            ...
            <div class="uk-margin">
              ...
              <div class="uk-form-controls uk-form-controls-text">
                <label
                  ><input class="uk-checkbox" type="checkbox" /> Option
                  01</label
                ><br />
                <label
                  ><input class="uk-checkbox" type="checkbox" /> Option
            ...
            <div class="uk-margin">
              <label class="uk-form-label" for="form-h-multiple"
                >Multiple</label
              >
              <div class="uk-form-controls">
                <select
            ...
            <div class="uk-margin">
              ...
              <div class="uk-form-controls uk-form-controls-text">
                <input
                  id="form-h-range"
                  class="uk-range uk-form-width-large"
                  type="range"
                  value="2"
                  min="0"
                  max="10"
          ...
          <form>
            <div class="uk-margin" uk-margin>
              <textarea
                class="uk-textarea uk-form-width-small uk-form-large"
                rows="2"
                placeholder="Some text..."
                aria-label="Large"
              ></textarea>
              <input
                class="uk-input uk-form-width-small uk-form-large"
                type="text"
                placeholder="Some text..."
                aria-label="Large"
              />
              <select
                class="uk-select uk-form-width-small uk-form-large"
                aria-label="Large"
              >
                <option>Option 01</option>
                <option>Option 02</option>
              ...
              <label
                ><input class="uk-checkbox" type="checkbox" /> Checkbox</label
              >
            </div>

            <div class="uk-margin" uk-margin>
              <textarea
                class="uk-textarea uk-form-width-small"
                rows="2"
                placeholder="Some text..."
                aria-label="Default"
              ></textarea>
            ...
            <div class="uk-margin" uk-margin>
              <textarea
                class="uk-textarea uk-form-width-small uk-form-small"
                rows="2"
                placeholder="Some text..."
                aria-label="Small"
              ></textarea>
          ...
          <form>
            <div class="uk-margin" uk-margin>
              <input
                class="uk-input uk-form-width-large"
                type="text"
                placeholder="form-width-large"
                aria-label="Width large"
              />
            </div>
            ...
            <div class="uk-margin" uk-margin>
              <input
                ...
                type="text"
                placeholder="form-width-medium"
                aria-label="Width medium"
              />
              <input
                class="uk-input uk-form-width-small"
                type="text"
                placeholder="form-width-small"
                aria-label="Width small"
              />
              <input
                class="uk-input uk-form-width-xsmall"
                type="text"
                placeholder="form-width-xsmall"
                aria-label="Width xsmall"
              />
            </div>
          ...
          <form class="uk-form-stacked uk-child-width-1-3@m" uk-grid>
            ...
            <div>
              ...
              ><br />
              <label
                ><input class="uk-checkbox" type="checkbox" /> Unchecked</label
              ><br />
              <label
                ><input class="uk-checkbox" type="checkbox" /> Unchecked</label
              ><br />
            ...
            <div>
              ...
              <label
                ><input
                  class="uk-checkbox js-indeterminate"
                  type="checkbox"
                  disabled
                />
          ...
          <p>
            <span class="uk-label">Note</span> The hover and focus state for
            <code>uk-form-custom</code> are not styled by default, but you could
            use the adjacent sibling selector to do so.
          </p>
        </div>
        <form class="uk-form-stacked uk-width-1-3@s">
          ...
          <div class="uk-margin">
            ...
            <div
              class="uk-margin-small uk-grid-small uk-child-width-1-2"
              uk-grid
            >
              <div>
                <input
          ...
          <fieldset class="uk-fieldset">
            ...
            <div class="uk-margin">
              ...
              <select id="form-s-select" class="uk-select">
                <option>Option 01</option>
                <option>Option 02</option>
              </select>
            </div>
            ...
            <div class="uk-margin">
              <label class="uk-form-label" for="form-s-textarea"
                >Textarea</label
              >
              <textarea
                id="form-s-textarea"
            ...
            <div class="uk-margin">
              <span class="uk-form-label">Checkbox</span>
              <label
                ><input class="uk-checkbox" type="checkbox" /> Option 01</label
              ><br />
              <label
                ><input class="uk-checkbox" type="checkbox" /> Option 02</label
              >
              <div class="uk-margin uk-grid-small uk-child-width-auto" uk-grid>
                <label><input class="uk-checkbox" type="checkbox" /> A</label>
                <label><input class="uk-checkbox" type="checkbox" /> B</label>
            ...
            <div class="uk-margin">
              <label class="uk-form-label" for="form-s-multiple"
                >Multiple</label
              >
              <select id="form-s-multiple" class="uk-select" multiple>
                <option>Option 01</option>
                <option>Option 02</option>
                <option>Option 03</option>
                <option>Option 04</option>
            ...
            <div class="uk-margin">
              <label class="uk-form-label" for="form-s-password"
                >Password</label
              >
              <input
                id="form-s-password"
            ...
            <div class="uk-margin">
              ...
              <input id="form-s-file" class="uk-width-1-1" type="file" />
            </div>

            <div class="uk-margin">
              <label class="uk-form-label" for="form-s-color">Color</label>
              <input id="form-s-color" class="uk-input" type="color" />
            </div>

            <div class="uk-margin">
              <label class="uk-form-label" for="form-s-date">Date</label>
              <input id="form-s-date" class="uk-input" type="date" />
            </div>

            <div class="uk-margin">
              <label class="uk-form-label" for="form-s-month">Month</label>
              <input id="form-s-month" class="uk-input" type="month" />
            </div>

            <div class="uk-margin">
              <label class="uk-form-label" for="form-s-week">Week</label>
              <input id="form-s-week" class="uk-input" type="week" />
            </div>

            <div class="uk-margin">
              <label class="uk-form-label" for="form-s-time">Time</label>
              <input id="form-s-time" class="uk-input" type="time" />
            </div>

            <div class="uk-margin">
              <label class="uk-form-label" for="form-s-datetimelocal"
                >Datetime local</label
              >
              <input
                id="form-s-datetimelocal"
                class="uk-input"
                type="datetime-local"
              />
            </div>
